...
public class Route extends DatabaseObject implements Serializable {
    ...
    public Route(int id, int cityId, int transportId, int kindRouteId, String routeNumber, String routeTitle, String fare, String traffic, String workingTime, int transportClassId, String paymentMethods, String itinerary, String company) {
        this.mId = id;
        this.mCityId = cityId;
