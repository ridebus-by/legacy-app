...
import org.xtimms.ridebus.components.IntegerPreference;
import org.xtimms.ridebus.ui.StringJoinerCompat;

import java.util.Set;

public abstract class PreferencesUtils {

    private static void bindPreferenceSummary(@Nullable Preference preference) {
        if (preference != null) {
    ...
    @NonNull
    private static String buildSummary(@NonNull MultiSelectListPreference preference, @NonNull Set<String> values,
