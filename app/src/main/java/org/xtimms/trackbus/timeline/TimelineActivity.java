...
import org.xtimms.trackbus.timeline.stops.StopsAdapter;
import org.xtimms.trackbus.util.DateTime;

import java.util.List;

public class TimelineActivity extends AppBaseActivity implements TimeLineActivityPresenter.View, StopsAdapter.OnStopClickListener {
    ...
    @Override
    public void onStopClick(int pos, List<StopsActivityTimeLineObject> stopsActivityTimeLineObjects) {
        Intent intent = ScheduleActivity.newIntent(this, mRoute,
                stopsActivityTimeLineObjects.get(pos).getStop());
